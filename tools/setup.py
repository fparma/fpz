...
def main():
    ...
    print("""
  ######################################
  # fpz3 Development Environment Setup #
  ######################################

  This script will create your fpz3 dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your fpz3 project folder:
    [Arma 3 installation directory]\\{} => fpz3 project folder
    P:\\{}                              => fpz3 project folder
